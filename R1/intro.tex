\section{Introdução}
    ...
    %TODO: Revisar esse parágrafo acima inteiro -TheFire888 (TF8)
    ...
    %TODO: Dava pra ser mais objetivo -TF8
    ...
    %TODO: Dava pra ser mais objetivo, muito texto vazio -TF8
    ...
    %TODO: O começo do parágrafo está ruim, talvez introduzir melhor? 
    % Só agora inicia a introdução teórica, melhorar isso.
    % Não está claro que essas leis são para fluidos estáticos, falar com
    % antecedência -TF8
    ...
    %TODO: Melhorar esses objetivos, talvez colocar numa seção separada -TF8
