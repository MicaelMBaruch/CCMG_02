...
% TODO: Justino, não seria interessante não deixar em tópicos? E sim como um texto corrido.
...
% TODO: Talvez fosse interessante citar algum artigo que testa as hipóteses do Lynch

\subsection{Extensão de Cenários Simples} %ESSA É CRITÉRIO AVALIATIVO
% Tópicos avaliativos: 1 e 2
%TODO: adicionar texto:
simulação análoga ao processo biológico que 
...
% TODO: Aqui é importante adicionar quais outros diferenciais nossa simulação tem
	
\section{Queiroz} %QUEIROZ VAI VER SE FICA MELHOR AQUI OU NO RSLT
Escrever stroytelling: tentamos, parecia errado, buscamos, literatura falou que é isso ai.
