...
\begin{minipage}{\linewidth}
    (A) \includegraphics[width=.45\linewidth]{figs/5_100individuals_geneCloneCost.png}
    (B) \includegraphics[width=.45\linewidth]{figs/5_1000individuals_geneCloneCost.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=1.0\linewidth]{figs/Gráficos_projeto.png}
