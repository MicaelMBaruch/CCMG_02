...
metodologia de Graça e colegas é baseada em Reação em Cadeia da Polimerase (do
inglês \textit{Polymerase Chain Reaction}, PCR) seguida de análise por
polimorfismo de fragmento de restrição (do inglês \textit{Polymerase Chain
Reaction -- Restriction Fragment Length Polymorphism}, PCR-RFLP). Conquanto, a
metodologia de Zampieri e colegas é baseada na PCR em tempo real (qPCR) acoplada
a análise de Alta de Resolução de Dissociação (do inglês \textit{High Resolution
Melting}, HRM) do DNA. 
